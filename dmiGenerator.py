...
def dmiGenerator(verbose,graphical,input,string,stats,number=3):
    '''verbose: Booléen pour avoir des informations supplémentaires
    graphical: Booléen pour indiquer si on veut une représentation graphique
    input: None si on ne rentre pas de séquence génomique
    string: Booléen pour avoir la liste des DMIs sous forme de chaine de caractère
    stats: Booléen pour avoir la répartition des mis et dis
    number: Taille du génome'''
